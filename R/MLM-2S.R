...
################################################################################
#' Results of the mixed linear regressions for mean methylation level in function 
#' of repeated exposure measurements
#'
...
################################################################################
#' Run Mixed Linear regression for estimating average exposure level
#' (when repeatedly measured)
#'
#' @param data A data.frame containing all variables needed for regression (exposures)
#' @param exposure A character string with the exposure name
#' @param time A character string with the time variable name (for fitting autocorrelation AR1 model). Default: NULL
#' 
...
#' @importFrom nlme lme
#'
#' @return A 2-column data.frame: id x average exposure.

MLM2_stage1 <- function(exposure, time = NULL, data){
...
LocusWiseMLM2_Stage2 <- function(meth_data,
                                 covariates,
                                 exposures,
                                 clinical_confounders,
                                 technical_confounders,
